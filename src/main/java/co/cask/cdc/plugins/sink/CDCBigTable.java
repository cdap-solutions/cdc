...
//        try (Connection connection = ConnectionFactory.createConnection(conf);
        // TODO: no such thing as namespace
        // TODO: io.grpc.StatusRuntimeException: INVALID_ARGUMENT: Invalid id for collection tables : Should match [_a-zA-Z0-9][-_.a-zA-Z0-9]* but found 'ns:abcd'
        // dot allowed, colon is not.
