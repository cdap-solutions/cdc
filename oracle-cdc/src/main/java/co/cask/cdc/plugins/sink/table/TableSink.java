...
public class TableSink extends BatchWritableSink<StructuredRecord, byte[], Put> {
  ...
  public void initialize(BatchRuntimeContext context) throws Exception {
    ...
    this.recordMutationTransformer = new RecordMutationTransformer(tableSinkConfig.getRowField(),
                                                                   tableSinkConfig.getOpTypeField(),
                                                                   tableSinkConfig.getBeforeField(),
                                                                   tableSinkConfig.getAfterField(),
                                                                   outputSchema);
  }
  ...
  public void transform(StructuredRecord input, Emitter<KeyValue<byte[], Put>> emitter) throws Exception {
    Put put = RecordMutationTransformer.toMutation(input);
